...
export default function CataloguePage() {
  ...
  }, [products, search, selectedCats, selectedBrands]);

  const activeFilters = selectedCats.length + selectedBrands.length;
  const filterProps = { categories, brands, selectedCats, selectedBrands, toggleFilter, setSelectedCats, setSelectedBrands, activeFilters };
