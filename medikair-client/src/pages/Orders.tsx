...
import { Package, ChevronDown, ChevronUp, RotateCcw, FileText, Truck, Clock, CheckCircle2, Loader2 } from "lucide-react";
                  ...
                  <button onClick={() => setExpanded(isOpen ? null : order._id)}
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
                        <span className="font-display text-sm font-bold sm:text-base">{order._id.slice(-8).toUpperCase()}</span>
                        ...
                        <div className="border-t border-border p-3 sm:p-5">
                          ...
                          <div className="mt-3 flex flex-col gap-2 border-t border-border pt-3 text-xs sm:mt-4 sm:flex-row sm:flex-wrap sm:items-center sm:gap-3 sm:pt-4 sm:text-sm">
                            ...
                            <div className="ml-auto flex gap-2">
                              <Button size="sm" className="bg-hero-gradient text-primary-foreground" onClick={() => reorder(order)}>
                                <RotateCcw className="mr-1.5 h-3.5 w-3.5" />Commander à nouveau
                              </Button>
                            </div>
                          </div>
                        </div>
