          ...
          <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
            ...
            {isRegister && (
              <div>
                ...
                <Input id="cabinet" placeholder="Cabinet Dentaire Tunis Centre" className="mt-1.5" value={formData.cabinet} onChange={handleChange} />
              </div>
            )}
            <div>
              <Label htmlFor="email">Email professionnel</Label>
              <Input id="email" type="email" placeholder="dr.ahmed@cabinet.tn" className="mt-1.5" value={formData.email} onChange={handleChange} />
            </div>
            <div>
            ...
            <Button type="submit" disabled={loading} className="w-full bg-hero-gradient text-primary-foreground hover:opacity-90 font-semibold">
