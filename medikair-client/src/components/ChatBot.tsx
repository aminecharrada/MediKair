...
const botResponses: Record<string, string> = {
  "composite": "Nous avons plusieurs composites disponibles ! Le **Composite Universel Nano-Hybride** de DentaPro est notre best-seller à 42.50 TND. Voulez-vous que je vous montre les options ?",
  "livraison": "Nous livrons sous **24-48h** sur toute la Tunisie. La livraison est **gratuite** pour les commandes de plus de 500 TND. 🚚",
  "prix": "Nos prix sont très compétitifs pour le marché B2B tunisien. N'hésitez pas à me demander le prix d'un produit spécifique !",
  "implant": "Notre **Implant Conique Ti Grade 5** d'ImplantPro est disponible à 189 TND. Surface SLA, connexion hexagonale interne. Excellent rapport qualité/prix !",
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-6 right-6 z-50 flex h-[480px] w-[360px] flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-xl"
          >
            {/* Header */}
